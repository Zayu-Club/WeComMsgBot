...
def getTextMessageJson(agent_id,content,touser=None,toparty=None,totag=None,safe=0,\
...
def getImageMessageJson(agent_id,media_id,touser=None,toparty=None,totag=None,safe=0,\
    enable_duplicate_check=0,duplicate_check_interval=1800):
    message_dic = {\
        'touser':touser,\
        'toparty':toparty,\
        'totag':totag,\
        'msgtype':MaterialType.image.name,\
        'agentid':agent_id,\
        'image':{\
            'media_id':media_id\
        },\
...
def getVoiceMessageJson(agent_id,media_id,touser=None,toparty=None,totag=None,\
    enable_duplicate_check=0,duplicate_check_interval=1800):
    message_dic = {\
        'touser':touser,\
        'toparty':toparty,\
        'totag':totag,\
        'msgtype':MaterialType.voice.name,\
        'agentid':agent_id,\
        'voice':{\
            'media_id':media_id\
        },\
...
def getVideoMessageJson(agent_id,media_id,video_title,video_description,touser=None,\
    toparty=None,totag=None,safe=0,enable_duplicate_check=0,duplicate_check_interval=1800):
    message_dic = {\
        'touser':touser,\
        'toparty':toparty,\
        'totag':totag,\
        'msgtype':MaterialType.video.name,\
        'agentid':agent_id,\
        'video':{\
            'media_id':media_id,\
            'title':video_title,\
...
def getFileMessageJson(agent_id,media_id,touser=None,toparty=None,totag=None,safe=0,\
    ...
    message_dic = {\
        ...
        'toparty':toparty,\
        'totag':totag,\
        'msgtype':MaterialType.file.name,\
        'agentid':agent_id,\
        'file':{\
            'media_id':media_id\
        },\
